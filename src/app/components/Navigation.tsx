    ...
    <header className="bg-gray-900 shadow-lg sticky top-0 z-50 border-b border-gray-800">
      <nav className="w-full px-6 lg:px-8">
        <div className="flex justify-between items-center h-16 lg:grid lg:grid-cols-3">
          ...
          {/* Right Side - Desktop Contact + Mobile Menu Button */}
          <div className="flex justify-end lg:justify-end">
            ...
            <div className="hidden lg:flex items-center space-x-3">
              ...
              <Link href="/contact" className="inline-flex items-center px-3 py-2 bg-transparent border border-gray-600 text-white rounded-full font-medium hover:bg-gray-800 hover:border-gray-400 transition-all duration-300 text-sm">
